...
export class CloneSeasonController {
    ...
    @Post('clone')
    @ApiOperation({summary: 'Clone a season', description: 'Clone shadows and services into a new season' })
    @ApiResponse({status: 201, description: 'The season has been cloned.', type: SeasonResponse})
    @ApiResponse({status: 500, description: 'The season has not been cloned. Server Error'})
